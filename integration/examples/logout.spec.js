...
it("Logout", function() {
   ...
   cy.wait(3000)
    ...
    cy.get(':nth-child(1) > .sc-hMqMXs > .sc-kEYyzF > a > .sc-iAyFgw')
     ...
     //Click log out dropdown
     cy.get('.bQbuwn > .eynJfY > svg').click()

     //Click logout
     cy.get('[href="/logout"] > .sc-gzVnrw').click()


     //Assert that user has been successfully logged out of the app

     //New to warenext content
     cy.get('.sc-jJkQYJ').should("be.visible")
